export const generateForgotPasswordEmail = (resetURL, username) => {
  const mailTemplate = `
<!doctype html>
<html lang="en">
  <head>
  ...
  <body style="margin:0; padding:0; background-color:#f4f6f8; font-family: system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial; color:#111;">
    <span style="display:none; font-size:1px; color:#f4f6f8; max-height:0; max-width:0; opacity:0; overflow:hidden;">
      Reset your password for your Auth Server account.
    </span>
            ...
            <tr>
              <td style="padding:28px 28px 20px;">
                ...
                <p style="margin:0 0 20px; font-size:16px; line-height:24px; color:#334155;">
                  Hi ${username},<br />
                  We received a request to reset your password for your <strong>Auth Server</strong> account. You can set a new password by clicking the button below.
                </p>
                ...
                <p style="word-break:break-all; font-size:13px; color:#0ea5a4; margin:0 0 20px;">
                  <a href="${resetURL}" style="color:#0ea5a4; text-decoration:underline;">${resetURL}</a>
                </p>

                <hr style="border:none; border-top:1px solid #eef2f7; margin:18px 0;" />

                <p style="margin:0; font-size:13px; color:#64748b;">
                  This password reset link will expire in <strong>1 hour</strong>. If you didn’t request a password reset, you can safely ignore this email or contact us at
          ...
          <table role="presentation" width="600" style="max-width:600px; margin-top:10px;">
            <tr>
              <td style="padding:12px; text-align:center; font-size:12px; color:#99a3b1;">
                You received this email because you requested a password reset for your Auth Server account. If this wasn’t you, please ignore it.
              </td>
            </tr>
          </table>
        </td>
